...
void UDialogueEdGraphSchema::GetGraphContextActions(FGraphContextMenuBuilder& ContextMenuBuilder) const
{
	...
	//NewSceneNodeAction->NodeTemplate->DialogueNode = NewObject<USceneDialogueNode>(NewSceneNodeAction->NodeTemplate);
	//NewSceneNodeAction->NodeTemplate->DialogueNode->Graph = Graph;
	...
	//NewInteractiveNodeAction->NodeTemplate->DialogueNode = NewObject<UInteractiveDialogueNode>(NewInteractiveNodeAction->NodeTemplate);
	//NewInteractiveNodeAction->NodeTemplate->DialogueNode->Graph = Graph;
}
...
//UEdGraphPin* UDialogueEdGraphSchema::DropPinOnNode(UEdGraphNode* InTargetNode, const FName& InSourcePinName, const FEdGraphPinType& InSourcePinType, EEdGraphPinDirection InSourcePinDirection) const
//{
//	UDialogueEdNode* EdNode = Cast<UDialogueEdNode>(InTargetNode);
...
//}
//
//bool UDialogueEdGraphSchema::SupportsDropPinOnNode(UEdGraphNode* InTargetNode, const FEdGraphPinType& InSourcePinType, EEdGraphPinDirection InSourcePinDirection, FText& OutErrorMessage) const
//{
//	return Cast<UDialogueEdNode>(InTargetNode) != nullptr;
//}
