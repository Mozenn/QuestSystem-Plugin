...
DECLARE_DYNAMIC_DELEGATE_TwoParams(FQuestEventDelegate_Bool, FQuestEventResult_Bool, OldValue, bool, bValue);
DECLARE_DYNAMIC_DELEGATE_TwoParams(FQuestEventDelegate_Int, FQuestEventResult_Int, OldValue, uint8, IntValue);
DECLARE_DYNAMIC_DELEGATE_TwoParams(FQuestEventDelegate_String, FQuestEventResult_String, OldValue, FString, StringValue);
