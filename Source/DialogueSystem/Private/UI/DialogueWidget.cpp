...
void UDialogueWidget::DisplayScene(UTexture2D* SceneTexture)
{
	Switcher->SetActiveWidgetIndex(0); 
...
void UDialogueWidget::DisplayInteractiveScene(UInteractiveDialogueSceneWidget* InteractiveSceneWidget)
{
